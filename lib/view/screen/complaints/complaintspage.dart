                  ...
                  builder: (controller) {
                    return Column(
                      children: [
                        ...
                        controller.complaintStatusRequest == StatusRequest.loading ? 
                        Center(child: Lottie.asset(AppImageAssets.loding,height: 150,repeat: true)) :
                        controller.complaintStatusRequest == StatusRequest.noData?
                        Center(child: Lottie.asset(AppImageAssets.noData,height: 150)) 
                       :ListView.builder(
                          shrinkWrap: true,
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ComplaintCard(
                              ...
                              onDelete: () {
                                controller.deleteComplaints(item.id.toString());
                              },
                            );
                          },
                        ),
